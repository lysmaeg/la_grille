...
private:
  ...
  void brute_force_recur(GridLinkGuard *glg, int pieces_left, int *nb_thread,
                         bool red_placed, int *nb_tested);
  void brute_force_launcher(GridLinkGuard *glg, int pieces_left, int *nb_thread,
                            bool red_posed, int x, int y, char c,
                            int *nb_tested);

  int ***build_scores_tab(int black, int green, int yellow, int red,
                          bool all) const;
...
public:
  ...
  void update_green_scores_tab(int ***scores_tab, int line, int column,
                               int index);
  void update_yellow_scores_tab(int ***scores_tab, int line, int column,
                                int index);
  ...
  void fill_blank();
  void glouton_recur(GridLinkGuard *glg, int nb_red, int nb_black,
                     int places_pieces, int limit_recur, coupleLink *cl);
  void brute_force();
